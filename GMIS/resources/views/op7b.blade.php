<!DOCTYPE html>
<html>
<title>Search, view all students in a group - GMIS</title>
<head>
...
<!-- Operation View-->
  ...
  <div class="row">
        ...
        <form method="GET" action="{{route('op7_1b')}}" id="searchGroups">
        <div class="row">
            
			<div class="col-10 p-3">
 				<input type="text" class="form-control" name="searchgroup" placeholder="Enter group name">
        	</div>
            ...
            <h1 class="display-5 fs-4">Group List</h1>
 			<table class="table text-center px-2">
  				...
  				<tbody style="height: 10px !important; overflow: scroll; ">
    				<?php if(isset($gmis_studentGroup)){
                    ?>
    				...
    				<tr>
      					...
      					<td>{{$row->group_name}}</td>
      						<td>
                    			<form action="{{route('op7_2b',['id'=>$row->group_id])}}">
