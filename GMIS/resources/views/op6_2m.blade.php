<!DOCTYPE html>
<html>
<title>Search, view all meetings for a student - GMIS</title>
<head>
...
<!-- Operation View-->
  ...
  <div class="row">
        ...
        <form method="GET" action="{{route('op6_1m')}}" id="searchStudents">
        <div class="row">
 			...
 			<table class="table text-center px-2">
  				...
  				<tbody style="height: 10px !important; overflow: scroll; ">
    				<tr>
      					...
      					<td>{{$gmis_student->given_name}}</td>
            			<td>{{$gmis_student->family_name}}</td>
            
      					<td>
                    	<form action="{{route('op6_2m',['id'=>$gmis_student->student_id])}}">
